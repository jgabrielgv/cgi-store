import sha, shelve, time, Cookie, sys, os
sys.path.append('/Users/mcanales/Sites')
SESSION = None
class Session(object):
    ...
    def __init__(self, expires=None, cookie_path=None):
        ...
        session_dir = '/Users/mcanales/Sites' + '/session'
        ...
        nsid = sid + '.db'
        os.chmod('%s/sess_%s' % (session_dir, nsid), 0660)
